...
## Method
기본적으로 정책을 학습하는 알고리즘이고 reward를 설계하는 것에 가장 큰 공을 들인다. 
...
성능 향상을 위해 적용한 이런저런 테크닉들에 대한 설명.. 나중에 필요하면 읽어보기로 함.

### Dexterous Manipulation Benchmark with Human References
논문의 또 다른 주요 기여 중 하나는 벤치마크의 개발이다. 여러 *common human manipulation datasets*을 Issac Lab 환경으로 가져와 4,739개의 학습 환경을 만들었다. 